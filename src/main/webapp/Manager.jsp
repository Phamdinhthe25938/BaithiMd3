            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach items="listStaff" var="l">
                    <tr>
                        ...
                        <td>${l.phoneNumber}</td>
                        <td>${l.phong}</td>
                        <td>${l.phong.namePhong}</td>
                        <td>
                            <a href="/managerStaff?action=eidt&id=${l.id}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="/managerStaff?action=delete&id=${l.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/managerStaff?action=add" method="post">
